...
Recently, I have been working with React Js, Redux, Typescript, and Vanilla Js. I love working with React Js because of its freedom of coding patterns, multiple dependencies, and using Js to do the logic. I also prefer using Jest for the unit/integration tests, and Cypress for the end-to-end testing. Working on both to better approach TDD to reduce site breaks, and improve my code structure and refactoring patterns. <br /> <br />

When I am not coding, I am most definately watching a movie, designing, Listening to music, doing some art, or learning something new. 
      </div>
